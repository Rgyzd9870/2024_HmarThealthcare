...
#define	LCD_SDA_SET  	GPIOB->BSHR = GPIO_Pin_15  //GPIO_SetBits(GPIOB,GPIO_Pin_15)
#define	LCD_SCL_SET  	GPIOB->BSHR = GPIO_Pin_13  //GPIO_SetBits(GPIOB,GPIO_Pin_13)

#define	LCD_CS_SET  	GPIOB->BSHR = GPIO_Pin_12  //GPIO_SetBits(GPIOB,GPIO_Pin_12)
#define LCD_RST_SET   GPIOB->BSHR = GPIO_Pin_14  //GPIO_SetBits(GPIOB,GPIO_Pin_14)

#define	LCD_RS_SET  	GPIOC->BSHR = GPIO_Pin_5   //GPIO_SetBits(GPIOC,GPIO_Pin_5)
#define	LCD_BLK_SET  	GPIOB->BSHR = GPIO_Pin_1   //GPIO_SetBits(GPIOB,GPIO_Pin_1)

//液晶控制口置0操作语句宏定义

#define	LCD_SDA_CLR  	GPIOB->BCR = GPIO_Pin_15  //GPIO_ResetBits(GPIOB,GPIO_Pin_15)    
#define	LCD_SCL_CLR  	GPIOB->BCR = GPIO_Pin_13  //GPIO_ResetBits(GPIOB,GPIO_Pin_13)  

#define	LCD_CS_CLR  	GPIOB->BCR = GPIO_Pin_12  //GPIO_ResetBits(GPIOB,GPIO_Pin_12)  
#define LCD_RST_CLR   GPIOB->BCR = GPIO_Pin_14  //GPIO_ResetBits(GPIOB,GPIO_Pin_14)

#define	LCD_RS_CLR  	GPIOC->BCR = GPIO_Pin_5   //GPIO_ResetBits(GPIOC,GPIO_Pin_5) 
#define	LCD_BLK_CLR  	GPIOB->BCR = GPIO_Pin_1   //GPIO_ResetBits(GPIOB,GPIO_Pin_1)
